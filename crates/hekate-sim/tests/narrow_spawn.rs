...
//!
//! `hekate-sim` spawns a demand source through the family its mode template
...
use hekate_model::{BodyKind, CompiledScenario, parse_scenario_source_v2};
use hekate_sim::{AgentId, AgentMode, Event, RunConfig, Simulation, SnapshotDetail};
