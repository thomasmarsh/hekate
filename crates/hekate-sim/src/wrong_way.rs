...
//!   [`hekate_model::CompiledFacility::nominal_direction`], which must not be
...
//!   [`hekate_model::CompiledScenario::permission_effect`] or the traversal's
//!   own [`hekate_model::FacilityTraversalPolicy::nominal_effect`], or `None`
...
//!   [`hekate_model::CompiledScenario::wrong_way_policy`];
...
mod interval_tests {
    use super::*;
    use hekate_model::{ModeTemplateId, PathId, parse_scenario_source_v2};
