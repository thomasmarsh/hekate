...
//! benchmark lives in `apps/tangle-cli/tests/scenarios.rs`.

use tangle_model::{CompiledScenario, MovementId, SignalColor, parse_scenario_source};
use tangle_sim::{Event, RunConfig, Simulation, SnapshotDetail, VehicleProfile};
