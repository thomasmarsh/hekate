...
mod tests {
    ...
    use tangle_model::{CompiledScenario, PathId, parse_scenario_source};
    ...
    fn stop_decision() -> Option<ComplianceDecision> {
        Some(ComplianceDecision {
            ...
            color: tangle_model::SignalColor::Red,
            stop_line_gap_m: 5.0,
    ...
    fn region_edges_are_swept_and_report_one_violation_per_entry() {
        ...
        let region = RegionKey::Crossing(tangle_model::CrossingId::from_index(0));
        let mut store = AgentStore::default();
