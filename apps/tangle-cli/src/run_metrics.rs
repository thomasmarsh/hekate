...
pub struct ClosePassValues {
    ...
    ///
    /// [`ClearanceBandId`]: tangle_model::ClearanceBandId
...
fn pass_capability(scenario: &tangle_model::CompiledScenario) -> PassCapability {
...
mod tests {
    ...
    use tangle_sim::{ManeuverReasonCode, PassSide};
