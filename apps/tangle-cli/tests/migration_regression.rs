...
//! `apps/tangle-cli/tests/golden/<id>.migrated.trace.sha256`.
//!
...
//!
//! ```sh
//! cargo run -p tangle-cli -- migrate <scenario>.json5 --output /tmp/v2.json
//! cargo run -p tangle-cli -- run /tmp/v2.json --seed <seed> --ticks <ticks> \
//!   --hash-file apps/tangle-cli/tests/golden/<id>.migrated.trace.sha256
//! ```
//!
...
use tangle_cli::{Trace, canonical_trace, load_scenario};
use tangle_model::{
