...
//!
//! `tangle-tui` loads through `tangle_present::load_scenario`, so a fixture that
...
use tangle_present::load_scenario;
use tangle_tui::{BACKGROUND, ColorDepth, TuiSession};
