...
//! mode-specific presenter branch". The shared `hekate-present` shape decision
...
//! `crates/hekate-sim/tests/synthetic_template_no_branch.rs` uses: it observes
...
const VIEWER_MAIN: &str = include_str!("../../../apps/hekate-viewer/src/main.rs");
...
fn the_viewer_body_systems_name_no_mode_or_scenario() {
    ...
    assert_no_scenario_dispatch("apps/hekate-viewer/src/main.rs", source);
}
