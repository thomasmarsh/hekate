...
Generated from `convergence_evidence.json` (evidence_version 1, metric_definition_version 3) by `hekate-cli experiment --convergence --summary`. Every number below is that artifact's own.
