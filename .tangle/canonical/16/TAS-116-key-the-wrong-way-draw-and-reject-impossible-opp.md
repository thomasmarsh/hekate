...
- `crates/hekate-sim/src/rng.rs` (`STREAM_MANEUVER`, `derive_stream`,
...
- `crates/hekate-sim/src/wrong_way.rs`:
...
- `crates/hekate-sim/src/lib.rs`: re-exported `maneuver_draw` alongside the
...
Evidence: `cargo test -p hekate-sim --lib` 215 passed (8 new);
