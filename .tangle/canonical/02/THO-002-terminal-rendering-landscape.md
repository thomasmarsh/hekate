...
Which terminal rendering techniques can present the Hekate scene, and what does
...
Three techniques can present the Hekate scene; they are cumulative rather than
exclusive.
...
widget/layout tree, double buffering, and diffing, but Hekate's output is custom
