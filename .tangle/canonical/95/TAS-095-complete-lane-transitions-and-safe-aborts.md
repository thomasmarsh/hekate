...
Files: `crates/hekate-sim/src/sim.rs`, `prediction.rs`, `agent.rs`, `lib.rs`;
`crates/hekate-sim/tests/lane_transitions.rs` (7 -> 11 tests). No event or
...
Files: `crates/hekate-sim/src/sim.rs`, `agent.rs`;
`crates/hekate-sim/tests/lane_transitions.rs` (11 -> 12 tests) plus two crate
...
Files: `crates/hekate-sim/src/sim.rs`, `prediction.rs`, `agent.rs`, `lib.rs`;
`crates/hekate-sim/tests/lane_transitions.rs`. No event or trajectory version
...
integrated tree: `cargo test -p hekate-sim --test lane_transitions` (18 passed),
...
`cargo test -p hekate-sim` (192 lib + 12 `lane_transitions` + all suites, 361
