...
scenarios/phase2/inc1, their tangle-sim integration tests, and the
...
1. Adding the first version-2 scenario under `scenarios/` broke
   ...
   `apps/tangle-cli/**` test wiring, so the gate was widened to validate and
