...
summary: Braintree friction while executing the renderer conformance suite: stale ID allocation and ambiguous multi-frontier routing.
---
...
With [[THO-008-braintree-friction-terminal-capability-detection]] present in
...
`THO-007-braintree-friction-tui-session` already exists on disk, and `THO-008`
...
At the start of this session two hub members of [[IDX-001-tangle]] had a live
`next`:
...
and proposed changes. This node is finished; meta-analysis and any Braintree
