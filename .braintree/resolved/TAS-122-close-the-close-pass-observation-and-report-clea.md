...
3 (`apps/tangle-cli/src/run_metrics.rs`). [[TAS-140-accumulate-close-pass-metric-families]]
...
piece of the termination half: `apps/tangle-cli/src/trace.rs
...
and passed-body roles (`crates/tangle-sim/src/close_pass.rs`, its 17 unit tests and
