...
slow_targets=(
    ...
    "apps/hekate-cli/tests/inc2_determinism.rs the_inc2_seed_bank_batch_reproduces_every_per_seed_hash_and_event_stream"
    "apps/hekate-cli/tests/inc2_determinism.rs the_declared_seed_bank_runs_the_same_traces_as_an_explicit_seed_list"
    "apps/hekate-cli/tests/narrow_determinism.rs the_narrow_seed_bank_batch_reproduces_every_per_seed_hash_and_event_stream"
