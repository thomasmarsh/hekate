...
| `bus` | M | `CC-HEAVY`, `CC-TRANSIT` | `heavy_isolated_v2` (checked in), `transit_low_demand_v2` (planned) | Increments 3, 4 |
| `rigid_truck` | M | `CC-HEAVY` | `heavy_isolated_v2` (checked in) | Increment 3 |
